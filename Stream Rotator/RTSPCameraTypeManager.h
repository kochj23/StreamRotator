...
/// Detailed Google Home camera configuration
@interface RTSPGoogleHomeCameraConfig : RTSPCameraConfig

@property (nonatomic, strong) NSString *deviceID;
@property (nonatomic, strong) NSString *deviceType; // "CAMERA", "DOORBELL"
@property (nonatomic, strong, nullable) NSString *roomName;
@property (nonatomic, assign) BOOL isStreaming;
@property (nonatomic, strong, nullable) NSDate *streamExpiresAt;
@property (nonatomic, strong, nullable) NSURL *snapshotURL;
@property (nonatomic, strong, nullable) NSDictionary *deviceTraits;

// Capabilities
@property (nonatomic, assign) BOOL supportsLiveStream;
@property (nonatomic, assign) BOOL supportsSnapshot;
@property (nonatomic, assign) BOOL supportsTwoWayAudio;
@property (nonatomic, assign) BOOL supportsMotionDetection;
@property (nonatomic, assign) BOOL supportsSoundDetection;

/// Refresh stream URL (Google streams expire)
- (void)refreshStreamWithCompletion:(void (^)(BOOL success, NSError *_Nullable error))completion;

/// Capture snapshot
- (void)captureSnapshotWithCompletion:(void (^)(NSImage *_Nullable image, NSError *_Nullable error))completion;
